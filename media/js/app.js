...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        //删除可删除的选项卡JS
        /*$("#tabs-container").on( "click",' li i', function() {
            var num = $(this).parent().nextAll().length,thisCl = $(this).parent().attr("class");
            if(num==0 || thisCl=="active"){
                var panelId = $(this).prev().attr("href"),
                prevPanelId= $(this).parent().prev().find("a").attr("href");
                panelId = panelId.replace("#","");
                prevPanelId = prevPanelId.replace("#","");
                $(this).parent().prev().siblings().removeClass('active');
                $(this).parent().prev().addClass('active');
                $( this ).parent( "li" ).remove();
                $("#" + panelId).remove();
                $("#" + prevPanelId).addClass('active in');
            }else{
                $( this ).parent( "li" ).remove();
                $("#" + panelId).remove();
            }
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            var el = jQuery(el); 
            el.block({
                    message: '<img src="./assets/img/ajax-loader-7.gif" align="">',
        ...
        //ajax return blockui
        ajaxblockUI: function (code,msg) {
            var notyMsg = msg;
            var selector = $('#ajax_suc');
            ...
            selector.children('b').text(notyMsg);
            //var el = jQuery(el); 
            $.blockUI({
                    message: selector,
                    css: {
